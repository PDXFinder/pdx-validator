...
public class TableSetSpecificationTest {
  ...
  @Test
  public void builderMethods_givenRequiredFileSetList_setsRequiredFiles() {
    TableSetSpecification tableSetSpecification = TableSetSpecification.create();
    assertEquals(
        REQUIRED_TABLES,
        tableSetSpecification.addRequiredTables(REQUIRED_TABLES).getRequiredTables());
  }

  @Test
  public void addRequiredColumns_givenTableColumnTwice_storesOnceInField() {
    TableSetSpecification expected =
        TableSetSpecification.create().addRequiredColumns(REQUIRED_COLUMN_1);
    assertEquals(
        expected,
  ...
  @Test
  public void addRequiredColumns_givenTwoTableColumnsSeparately_equalsGivenAsSet() {
    TableSetSpecification expected =
        TableSetSpecification.create()
            .addRequiredColumns(REQUIRED_COLUMN_1)
            .addRequiredColumns(REQUIRED_COLUMN_2);
    Set<ColumnReference> setOfRequiredColumns =
        new HashSet<>(Arrays.asList(REQUIRED_COLUMN_1, REQUIRED_COLUMN_2));

    assertEquals(expected, TableSetSpecification.create().addRequiredColumns(setOfRequiredColumns));
  }

  @Test
  public void toString_givenRequiredFiles_returnsAppropriateMessage() {
    TableSetSpecification tableSetSpecification =
        TableSetSpecification.create().addRequiredTables(new HashSet<>(Arrays.asList("file1.tsv")));

    assertEquals("[file1.tsv]", tableSetSpecification.getRequiredTables().toString());
  }

  @Test
  public void merge_givenOneSpecification_returnsEqualSpecification() {
    Set<String> requiredTables = new HashSet<>(Collections.singletonList("table1.tsv"));
    TableSetSpecification expected =
        TableSetSpecification.create().setProvider("provider").addRequiredTables(requiredTables);
    assertEquals(expected, TableSetSpecification.merge(expected));
  }

  @Test
  public void merge_givenTwoDifferentSpecifications_returnsCombinedSpecification() {
    Set<String> requiredTables = new HashSet<>(Collections.singletonList("table1.tsv"));
    ...
    TableSetSpecification specfication1 =
        TableSetSpecification.create().setProvider("provider").addRequiredTables(requiredTables);
    TableSetSpecification specfication2 =
        TableSetSpecification.create().setProvider("provider").addRequiredTables(requiredTables2);
    assertEquals(expected, TableSetSpecification.merge(specfication1, specfication2));
  }

  @Test
  public void merge_givenTwoIdenticalSpecification_returnsEqualSpecification() {
    Set<String> requiredTables = new HashSet<>(Collections.singletonList("table1.tsv"));
    TableSetSpecification expected =
        TableSetSpecification.create().setProvider("provider").addRequiredTables(requiredTables);
    assertEquals(expected, TableSetSpecification.merge(expected, expected));
  }

  @Test
  public void
      merge_givenTwoDifferentSpecificationsWithAllValidations_returnsCombinedSpecification() {
  ...
  @Test
  public void merge_givenTwoIdenticalSpecificationWithAllValidations_returnsEqualSpecification() {
    Set<String> requiredTables = new HashSet<>(Collections.singletonList("table1.tsv"));
    Set<ColumnReference> requiredColumns =
        new HashSet<>(Collections.singletonList(ColumnReference.of("table1", "column1")));
    TableSetSpecification expected =
        TableSetSpecification.create()
            .setProvider("provider")
            .addRequiredTables(requiredTables)
