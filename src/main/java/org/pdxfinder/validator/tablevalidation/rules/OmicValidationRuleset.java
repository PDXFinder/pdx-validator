...
public class OmicValidationRuleset extends ValidationRuleCreator {
  ...
  public static TableSetSpecification generateFor(String tableName, String provider) {
    ...
    Set<ColumnReference> hostStrainColumns =
        matchingColumnsFromAnyTable(tableColumns, "host_strain");
    ...
    Set<ColumnReference> essentialCytogeneticsColumns =
        matchingColumnsFromTable(
            tableColumns,
            "cyto",
