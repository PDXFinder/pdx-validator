...
public class PdxValueRestrictions {
  ...
  private static final ValueRestrictions URL_SAFE_CHARSET =
      ValueRestrictions.of(
          "^[\\p{Alpha}\\p{Digit}\\p{Space}._~-]+$",
          "have characters not contained in US ASCII Alphanumeric and ._~-");

  private static final ValueRestrictions NUMERICAL_CHARSET =
      ValueRestrictions.of(
          "^[\\p{Digit}\\p{Space}pP\\.,-]+$",
  ...
  private static final ValueRestrictions COLLECTION_DATE_FORMAT =
      ValueRestrictions.of(
          "[A-Za-z]{3} [0-9]{4}", "not of type: [MMM YYYY] three letter month and 4 digit year");

  private static final ValueRestrictions PMID_FORMAT =
      ValueRestrictions.of(
          "(?i)^(?:pmid:\\s?[0-9]{8},?\\s?)*$",
          "not of type: PMID: [8 digit id] (comma separated)");

  private static final ValueRestrictions SEX_CATEGORIES =
      ValueRestrictions.of(
